...
'Debes ponerle nombre a tu servicio, al menos para poder generar una URL...': 'Debes ponerle nombre a tu servicio, al menos para poder generar una URL...',
'Delete': 'Elimine',
'Delete:': 'Elimine:',
'Deploy on Google App Engine': 'Instale en Google App Engine',
'Describe en 80 caracteres de qué trata tu servicio': 'Describe en 80 caracteres de qué trata tu servicio',
...
'Este nombre de servicio está ya utilizado. Intenta inventar otro.': 'Este nombre de servicio está ya utilizado. Intenta inventar otro.',
'First name': 'Nombre',
...
'Los servidores web comúnmente usan el 80, pero realmente depende del servidor': 'Los servidores web comúnmente usan el 80, pero realmente depende del servidor',
...
'Pone un nombre único, fácil de recordar a tu servicio': 'Pone un nombre único, fácil de recordar a tu servicio',
'Por defecto, esta IP es desde la que actualmente usas': 'Por defecto, esta IP es desde la que actualmente usas',
'Por ejemplo: ftp,dav...': 'Por ejemplo: ftp,dav...',
...
'Servicio': 'Servicio',
'Señala la ruta sin la barra "/" inicial': 'Señala la ruta sin la barra "/" inicial',
